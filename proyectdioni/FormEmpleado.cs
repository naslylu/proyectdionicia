    ...
    public partial class FormEmpleado : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                newRow["Edad"] = Convert.ToInt32(txt_Edad.Text);
                newRow["Cedula"] = txt_Cedula.Text;
                newRow["Telefono"] = txt_Telefono.Text;
                newRow["Direccion"] = txt_Direccion.Text;
                newRow["Genero"] = cmb_Genero.SelectedItem.ToString();
                newRow["Sueldo"] = Convert.ToDecimal(txt_Sueldo.Text);
        ...
        private void btn_Eliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                int selectedIndex = dgv_empleado.SelectedRows[0].Index;
                dgv_empleado.Rows.RemoveAt(selectedIndex);
                adapter.Update(dataTable);
        ...
        private void RealizarBusqueda()
        {
            ...
            if (!string.IsNullOrEmpty(searchTerm))
            {
                ...
                dgv_empleado.DataSource = filteredDataTable;
            }
            else
            {
                dgv_empleado.DataSource = dataTable;
